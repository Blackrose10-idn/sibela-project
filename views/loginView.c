...
void drawStaffLogin(windowModel *windowM)
{
    ...
    DrawTextEx(windowM->fontStyle.medium, "Masuk", (Vector2){(int)buttonBox.x + buttonBox.width / 2 - MeasureTextEx(windowM->fontStyle.medium, "Masuk", 40, 0).x / 2, (int)buttonBox.y + MeasureTextEx(windowM->fontStyle.medium, "Masuk", 40, 0).y / 2 - 8}, 40, 0, SIBELAWHITE);
}
